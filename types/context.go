...
func (c Context) ValidatorCreationDisallowed() bool { return c.disallowValidatorCreation }
...
func (c Context) WithDisallowValidatorCreation(disallow bool) Context {
	c.disallowValidatorCreation = disallow
	return c
}
